...
(define-private (try-commit-consensus (new-bps uint))
  (let
    ((r0    (default-to u0 (map-get? oracle-reports u0)))
     ...
     (live0 (> (default-to u0 (map-get? oracle-report-block u0)) u0))
     (live1 (> (default-to u0 (map-get? oracle-report-block u1)) u0))
     (live2 (> (default-to u0 (map-get? oracle-report-block u2)) u0)))
